      ...
      <header className="bg-scriptbox-orange w-full">
        <div className="max-w-screen-lg mx-auto py-2 px-4 lg:px-0 flex justify-between items-center">
          <div className="flex items-center">
            ...
            >
              <figure>
                <svg className="h-6  w-6 text-white" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M4 6h16M4 12h16M4 18h16"></path></svg>
