...
const SectionTwo = props => {
  ...
  const renderHeading = () => (
    <div className="text-center sm:text-left max-w-33.5 xl:max-w-full mx-auto">
      ...
      <h2 className="text-scriptbox-black-1 text-1.75 font-bold pt-3 pb-2 leading-tight">
  ...
  return (
    <section className="px-2  pt-24 pb-20 lg:px-4 bg-scriptbox-blue-1">
      <div className={`hidden lg:grid max-w-screen-lg mx-auto grid-cols-2 ${styles.section_two_parent_grid} gap-0-1.5 xl:gap-0-10.5`}>
        <div className="max-w-23.75">
          {renderHeading()}


          <div className="max-w-21.875">
            {renderAccordian()}
