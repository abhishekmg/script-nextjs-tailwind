...
const SectionTwo = props => {
  ...
  const renderRightGrid = () => (
    <div className="mt-4  rounded-md max-w-lg lg:w-full">
      ...
      <div className="flex  items-center">
        <div className={`rounded-tl-md p-6 bg-white shadow-2 max-w-15.9 w-full relative ${styles.section_two_top_left_div}`}>
        ...
        <div className={` rounded-tr-md p-6 bg-white relative max-w-17.815 w-full shadow-2 ${styles.section_two_top_right_div}`}>
      ...
      {/* second row */}
      <div className="flex items-center">
        <div className="rounded-bl-md p-6 bg-white  shadow-2 max-w-15.9 w-full ">
        ...
        <div className="rounded-br-md p-6 bg-white shadow-2 max-w-17.815 w-full">
          {state.sectionTwoActiveTab ?
  ...
  return (
    <section className="px-2  pt-24 pb-20 lg:px-4 bg-scriptbox-blue-1">
      <div className=" hidden lg:grid max-w-screen-lg mx-auto grid-cols-2">
